        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SubTitle = table.Column<string>(type: "VARCHAR(25)", nullable: false),
                    NumberPage = table.Column<string>(type: "CHAR(4)", nullable: false),
                    NumberEdition = table.Column<string>(type: "CHAR(3)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Book_Account", x => new { x.AccountId, x.BookId });
                    table.ForeignKey(
                        name: "Fk_AccountId",
